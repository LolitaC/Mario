...
public class Resource<T> implements IResource<T> {
    ...
    public static Resource<BufferedImage> loadImg(File file) throws IOException {
        ...
        output.storage.put("MARIO$LARGE$TURN", new BufferedImage[] {CommonUtil.createHorzFlipped(img.getSubimage(71, 548, 16, 32))});
        ...
        output.storage.put("QUESTION$NORMAL$STAND",new BufferedImage[] {img.getSubimage(372, 160, 16, 16),
                ...
                img.getSubimage(390, 160, 16, 16)});
        // 顶过的问号
        output.storage.put("QUESTION$NORMAL$WALK",new BufferedImage[] {img.getSubimage(373, 65, 16, 16)});
